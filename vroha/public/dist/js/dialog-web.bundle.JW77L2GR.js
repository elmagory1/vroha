(() => {
  ...
  // ../vroha/vroha/public/js/frappe/form/layout.js
  frappe.ui.form.Layout = class Layout {
    ...
    make() {
      ...
      this.message = $('<div class="form-message d-none"></div>').appendTo(this.wrapper);
  ...
  // ../vroha/vroha/public/js/frappe/ui/field_group.js
  ...
  // ../vroha/vroha/public/js/frappe/ui/dialog.js
  frappe.provide("frappe.ui");
  ...
  frappe.ui.Dialog = class Dialog extends frappe.ui.FieldGroup {
    ...
    make() {
      ...
      if (this.secondary_action_label || (this.secondary_action || this.action.secondary && this.action.secondary.label)) {
        this.set_secondary_action_label(this.secondary_action_label || this.action.secondary.label || __("Ok"));
      }
      if (this.minimizable) {
...
//# sourceMappingURL=dialog-web.bundle.JW77L2GR.js.map
