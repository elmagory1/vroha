	...
	addButton(wrapper, id, type, hidden, name, action) {
		...
		if (type == "secondary") {
			button.classList.add(
				"ml-2", "text-uppercase", "bg-primary", "text-center",  "text-white" , "font-xsss", "fw-600", "p-3", "w175", "rounded-lg", "d-inline-block"
			);
		} else if (type == "danger") {
			button.classList.add(
				"ml-2", "text-uppercase", "bg-danger", "button-delete", "text-center",  "text-white" , "font-xsss", "fw-600", "p-3", "w175", "rounded-lg", "d-inline-block"
			);
		} else {
